          ...
          >
            ...
            <motion.div variants={itemVariant}>
              <p className="text-body-lg text-text-secondary leading-relaxed text-pretty max-w-lg">
                Skip the AdSense plateau. Click Dudes is a certified Google Multiple Customer Management partner — unlocking premium AdX demand, private deals, and AI-powered price floors for qualifying publishers.
              </p>
            </motion.div>
