...
const TEAM: TeamMember[] = [
  { name: "Rai Faizan",      role: "Founder & Visioner",                department: "Leadership",        bio: "Founder of Click Dudes, leading the company vision, monetization strategy, AI-powered ad-tech direction, and long-term growth ecosystem.",                                                  initials: "RF", accentBg: "bg-brand-purple/12", accentText: "text-brand-purple", years: "Founder"     },
  { name: "Syed Umer",       role: "Co-Founder & CFO",                  department: "Leadership",        bio: "Oversees finance, business operations, revenue planning, strategic partnerships, and sustainable growth execution for Click Dudes.",                                                        initials: "SU", accentBg: "bg-brand-blue/12",   accentText: "text-brand-blue",   years: "Co-Founder"  },
  { name: "Muhammad Sami",   role: "CEO",                               department: "Leadership",        bio: "Leads company execution, operational strategy, team management, publisher growth, and business development across the Click Dudes ecosystem.",                                              initials: "MS", accentBg: "bg-brand-violet/12", accentText: "text-brand-violet" },
