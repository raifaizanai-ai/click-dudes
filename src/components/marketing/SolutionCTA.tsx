...
const DEFAULT_TRUSTS       = ["1,200+ Publishers", "GCPP Verified", "30-Day Results", "No Lock-in"]
        ...
        <div className="relative z-10">
          ...
          <div className="absolute -left-16 top-1/2 -translate-y-1/2 pointer-events-none hidden xl:block">
            <div className="relative">
              <RobotImage variant={robotVariant} size="lg" floatDelay={1} glowColor="purple" />
              <div
          ...
          <div className="absolute -right-20 bottom-0 opacity-70 pointer-events-none hidden xl:block">
            <RobotImage variant={robotVariant} size="md" floatDelay={2.5} glowColor="cyan" />
          </div>
